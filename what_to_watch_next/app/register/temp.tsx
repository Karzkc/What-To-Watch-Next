    ...
    <div className={`min-h-svh pt-[100px] flex justify-center items-center text-white ${bg}`}>
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            disabled={loading}
            className="mt-2 py-2 rounded-md bg-purple-500 hover:bg-purple-600 transition-all font-josefin disabled:opacity-50"
          >
        ...
        <button
          type="button"
          onClick={handleGuest}
          className="w-full py-2 rounded-md border border-white/20 hover:bg-white/10 transition-all font-josefin"
        >
          Continue as Guest
        </button>
